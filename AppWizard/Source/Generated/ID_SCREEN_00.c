...
static const APPW_SETUP_ITEM _aSetup[] = {
  ...
  { ID_BUTTON_00,   APPW_SET_PROP_COLORS,       { ARG_V(0xffc0c0c0),
                                                  ARG_V(GUI_INVALID_COLOR),
                                                  ARG_V(GUI_INVALID_COLOR) } },
  { ID_BUTTON_00,   APPW_SET_PROP_TEXTID,       { ARG_V(ID_RTEXT_2) } },
  { ID_BUTTON_01,   APPW_SET_PROP_SBITMAPS,     { ARG_VP(0, acButtonDarkUnpressed_100x30),
                                                  ARG_VP(0, acButtonDarkPressed_100x30), } },
  { ID_BUTTON_01,   APPW_SET_PROP_COLORS,       { ARG_V(0xffc0c0c0),
                                                  ARG_V(GUI_INVALID_COLOR),
                                                  ARG_V(GUI_INVALID_COLOR) } },
  { ID_BUTTON_01,   APPW_SET_PROP_TEXTID,       { ARG_V(ID_RTEXT_3) } },
  ...
  { ID_BUTTON_02,   APPW_SET_PROP_SBITMAPS,     { ARG_VP(0, acButtonDarkUnpressed_100x30),
                                                  ARG_VP(0, acButtonDarkPressed_100x30), } },
  { ID_BUTTON_02,   APPW_SET_PROP_COLORS,       { ARG_V(0xff55aaff),
                                                  ARG_V(GUI_INVALID_COLOR),
                                                  ARG_V(GUI_INVALID_COLOR) } },
  { ID_BUTTON_02,   APPW_SET_PROP_TEXTID,       { ARG_V(ID_RTEXT_4) } },
  { ID_BUTTON_03,   APPW_SET_PROP_SBITMAPS,     { ARG_VP(0, acButtonDarkUnpressed_100x30),
                                                  ARG_VP(0, acButtonDarkPressed_100x30), } },
  { ID_BUTTON_03,   APPW_SET_PROP_COLORS,       { ARG_V(GUI_RED),
                                                  ARG_V(GUI_INVALID_COLOR),
                                                  ARG_V(GUI_INVALID_COLOR) } },
  { ID_BUTTON_03,   APPW_SET_PROP_TEXTID,       { ARG_V(ID_RTEXT_5) } },
};
