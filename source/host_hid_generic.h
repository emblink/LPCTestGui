...
typedef struct _usb_host_hid_generic_instance
{
    ...
    } endpoint[USB_HOST_CONFIG_INTERFACE_MAX_EP];
    uint8_t interfaceUsed;
    uint8_t interfaceProtocolType; /* should be keyboard or mouse protocol interface */
    uint8_t reportExtensionSupported;
